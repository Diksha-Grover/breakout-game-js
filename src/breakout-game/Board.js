  ...
  useEffect(() => {
    const render = () => {
      ...
      for (let i = 0; i < bricks.length; i++) {
        ...
        // if brick ball collides with brick and brick break
      ...
      <canvas
        ...
        onMouseMove={(event) =>
          (paddleProps.x =
            ...
            paddleProps.width / 2 -
            10)
            // clientX property returns the horizontal coordinate (according to the client area) of the mouse pointer when a mouse event was triggered.
            // client area is the current window
            // here client area is our canvas  
        }
        height="500"
        width={
